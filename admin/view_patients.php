...
<body>
			...
			?>
             ...
             <?php $query = mysqli_query($db, "SELECT * FROM patient") or die(mysqli_error($db)); ?>   
       ...
       <th>FirstName</th><th>LastName</th><th>Gender</th><th>Marital Status</th><th>Date of Birth</th>
       <th>Phone Number</th><th>Address</th><th>Blood Group</th><th>Blood Type</th><th>Previous Health Challenges</th>
       <th>Health Insurance</th>
       
       			</tr>
                
          <?php
   			$check = viewPatients($query);
				echo $check;    
          ?>
